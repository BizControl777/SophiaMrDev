      ...
      <Card className="w-full max-w-md border-border/50 bg-card/50 backdrop-blur-sm relative z-10">
        <CardHeader className="space-y-1 text-center">
          <div className="flex justify-center mb-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-xl overflow-hidden">
              <img src="/logo.jpg" alt="SophIA Logo" className="w-full h-full object-contain" />
            </div>
          </div>
          <CardTitle className="font-mono text-2xl font-bold tracking-tight">Acesso SophIA</CardTitle>
        ...
        <CardContent className="grid gap-6">
          <div className="grid gap-4">
            ...
            <Button onClick={handleLogin} disabled={isLoading} className="w-full bg-primary hover:bg-primary/90 font-bold h-11 mt-2">
              {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Entrar na SophIA"}
            </Button>
          </div>
          ...
          <Button variant="outline" className="w-full border-border/50 bg-muted/30 hover:bg-muted/50 font-semibold h-11">
        ...
        <CardFooter className="flex flex-wrap items-center justify-center gap-1 text-xs text-muted-foreground pb-8">
