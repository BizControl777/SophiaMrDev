    ...
    <View className="flex-1 bg-sophia-bg">
      ...
      <SafeAreaView className="flex-1 px-6 justify-between py-12">
        ...
        <View className="space-y-4 gap-4">
          ...
          <TouchableOpacity 
            className="bg-sophia-card border border-sophia-border h-16 rounded-2xl items-center justify-center"
          >
            <Text className="text-sophia-text font-bold text-lg">Saiba Mais</Text>
          </TouchableOpacity>

          <View className="items-center mt-4">
            <Text className="text-sophia-text3 text-xs uppercase tracking-widest font-bold">Powered by Gemini AI</Text>
          </View>
        </View>
      </SafeAreaView>
    </View>
